...
import os
os.chdir("/Users/noha/Desktop/Hilary_term /Applied ML/Summative/project/notebooks")
...
def feat_cols(n_lags):
    return [f'{c}_lag{k}' for c in FEATURE_COLS for k in range(1, n_lags+1)]          + ['week_of_year', 'year']
